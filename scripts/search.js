 ...
 *
 * @param {HTMLSelectElement} searchEngineEl google, yahoo, bing, youtube, duckduckgo, brave
...
export function setSearchEngine(searchEngineEl, engineFormEl, searchInputEl) {
  ...
  switch (engine) {
    ...
    case "duckduckgo":
      ...
      break;
    case "brave":
      engineFormEl.action = "https://search.brave.com/search";
      searchInputEl.name = "q";
      break;
    default:
...
export function initSearch() {
  /** Google, yahoo, bing, youtube, duck duck go, brave */
